# ADR-PML-177: Documented Lean theorems missing in the `adr-scaffold` subsystem (1 gaps)
...
### Implementation reality (lean/)
  - `RH_analytic_proof` not found among 7001 lean declarations
