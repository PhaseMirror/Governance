# ADR-PML-075: Documented physical/mathematical invariants asserted as guaranteed but risk not owned
...
## Dissonance Score
- Impact = severity (4) x blast radius (13) = **40**
- Tractability = **3.0**
- **Score = 120.0**  (cluster rank 2 of 4)
