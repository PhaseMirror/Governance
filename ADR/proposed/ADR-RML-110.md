# ADR-RML-110: document `Governance/docs/docs/RELEASE_NOTES.md` has 2 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/docs/docs/RELEASE_NOTES.md` (mtime 2026-07-23 20:14:57Z)
