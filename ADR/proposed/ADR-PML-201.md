# ADR-PML-201: Invariant enforcement: 8/9 theorems proven sorry-free; residual risk remains
...
## Dissonance Score
- Impact = severity (2) x blast radius (7) = **14**
- Tractability = **4.0**
- **Score = 56.0**  (cluster rank 2 of 3)
