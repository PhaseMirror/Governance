# ADR-PML-136: Documented Lean theorems missing in the `moc` subsystem (1 gaps)
...
### Implementation reality (lean/)
  - `SystemState_Phase1` not found among 6970 lean declarations
