# ADR-PML-184: Documented Lean theorems missing in the `general` subsystem (1 gaps)
...
### Stated intent (documents)
  - docs/adr/completed/ADR-090-Mathlib-Sorry-Elimination-Plan.md:36 — asserts `Init` exists / is verified

### Implementation reality (lean/)
  - `Init` not found among 7001 lean declarations
