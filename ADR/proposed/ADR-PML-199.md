# ADR-PML-199: Control surfaces linked via CertificationGate governance theorems; cross-layer (Lean↔Rust) enforcement gap remains
...
- Tractability = **2.0**
- **Score = 16.0**  (cluster rank 3 of 3)
