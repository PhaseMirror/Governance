# ADR-PML-104: alp_sorry_manifest.json permits sorrys that are absent from the current lean tree (stale boundary)
...
- Tractability = **5.0**
- **Score = 45.0**  (cluster rank 3 of 7)
...
### Stated intent (documents)
  - alp_sorry_manifest.json permits 3 sorry(s) not present in lean

### Implementation reality (lean/)
  - stale permitted sorrys: RH_analytic_proof, accepted_has_supersession_or_proposal, allExamples_have_valid_ids
