# ADR-PML-059: Documented Lean theorems missing in the `adr-scaffold` subsystem (5 gaps)
...
- Tractability = **1.0**
- **Score = 20.0**  (cluster rank 5 of 10)
...
### Stated intent (documents)
  - docs/adr/completed/ADR Prime Moves Scaffolding.md:64 — asserts `E_τ_star` exists / is verified
  - docs/adr/completed/ADR Prime Moves Scaffolding.md:67 — asserts `N` exists / is verified
  - docs/adr/completed/ADR Prime Moves Scaffolding.md:110 — asserts `T_crit` exists / is verified
  - docs/adr/completed/ADR Prime Moves Scaffolding.md:136 — asserts `RH_analytic_proof` exists / is verified
  - docs/adr/completed/ADR-057-LEAN4_ADR_SCAFFOLDING.md:145 — asserts `ADR_001_Riemann` exists / is verified

### Implementation reality (lean/)
  - `E_τ_star` not found among 6978 lean declarations
  - `N` not found among 6978 lean declarations
  - `T_crit` not found among 6978 lean declarations
  - `RH_analytic_proof` not found among 6978 lean declarations
