# ADR-RML-111: document `Governance/docs/docs/STABILITY_OWNERSHIP.md` has 2 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/docs/docs/STABILITY_OWNERSHIP.md` (mtime 2026-07-13 02:39:46Z)
