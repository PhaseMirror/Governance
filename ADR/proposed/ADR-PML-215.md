# ADR-PML-215: Formal-verification purity claims: 11 source doc(s) with residual historical/aspirational claims
...
## Dissonance Score
- Impact = severity (5) x blast radius (11) = **50**
- Tractability = **4.0**
- **Score = 200.0**  (cluster rank 1 of 3)
...
### Stated intent (documents)
  - docs/adr/Phase 4 Verification Roadmap.md:112 — claims [mathematically guaranteed] “4. **Contractive VQE:** This `MultiplicitySpace` is fed directly into the `ContractiveFit` operator we built previously,”
