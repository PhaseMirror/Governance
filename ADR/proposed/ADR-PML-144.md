# ADR-PML-144: Formal-verification purity claims contradict the UAC-ALP boundary reality
...
## Dissonance Score
- Impact = severity (5) x blast radius (80) = **50**
- Tractability = **3.0**
- **Score = 150.0**  (cluster rank 1 of 6)
