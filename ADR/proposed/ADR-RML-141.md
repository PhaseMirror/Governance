# ADR-RML-141: document `Governance/audit/PHASE-7-DIRECTIVE.md` has 1 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/audit/PHASE-7-DIRECTIVE.md` (mtime 2026-06-29 21:53:15Z)
