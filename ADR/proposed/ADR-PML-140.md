# ADR-PML-140: alp_sorry_manifest.json permits sorrys that are absent from the current lean tree (stale boundary)
...
- Tractability = **5.0**
- **Score = 15.0**  (cluster rank 4 of 7)
...
### Implementation reality (lean/)
  - stale permitted sorrys: allExamples_have_valid_ids
