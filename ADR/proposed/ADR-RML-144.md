# ADR-RML-144: document `Governance/audit/SOVEREIGN_SYNTHESIS_PUBLICATION.md` has 1 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/audit/SOVEREIGN_SYNTHESIS_PUBLICATION.md` (mtime 2026-06-29 21:32:23Z)
