# ADR-RML-140: document `Governance/audit/PHASE-6-DIRECTIVE.md` has 1 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/audit/PHASE-6-DIRECTIVE.md` (mtime 2026-06-29 21:50:52Z)
