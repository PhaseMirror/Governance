# ADR-PML-195: Accepted ADRs may be re-entrant (reopened without supersession): ADR-PML-070.md
...
### Implementation reality (lean/)
  - Accepted status must be immutable unless superseded (ADR.Governance.no_reentrant_acceptance)
