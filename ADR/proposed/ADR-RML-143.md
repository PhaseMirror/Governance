# ADR-RML-143: document `Governance/audit/PHASE-9-DIRECTIVE.md` has 1 stale claim(s)
## Status
Proposed

## Triage (time-aware phase mirror)
- Document: `Governance/audit/PHASE-9-DIRECTIVE.md` (mtime 2026-06-30 04:57:04Z)
