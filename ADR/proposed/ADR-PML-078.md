# ADR-PML-078: Formal-verification purity claims contradict the UAC-ALP boundary reality
...
## Dissonance Score
- Impact = severity (5) x blast radius (61) = **50**
- Tractability = **4.0**
- **Score = 200.0**  (cluster rank 1 of 4)
