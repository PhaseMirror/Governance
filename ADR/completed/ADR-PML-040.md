# ADR-PML-040: Documented physical/mathematical invariants asserted as guaranteed but risk not owned
...
- Tractability = **3.0**
- **Score = 84.0**  (cluster rank 1 of 9)
...
### Stated intent (documents)
  ...
  - docs/adr/ADR-PML-031.md:24 — - docs/PIRTM_SPEC.md:166 — 2. **Runtime checks** in the WardMonitor (ρ drift threshold). Telemetry tests enforce `ANOMAL
