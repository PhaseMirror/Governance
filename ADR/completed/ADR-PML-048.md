# ADR-PML-048: Documented Lean theorems missing in the `governance` subsystem (1 gaps)
...
### Implementation reality (lean/)
  - `FockTrunc` not found among 8285 lean declarations
