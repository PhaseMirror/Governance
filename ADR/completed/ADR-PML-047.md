# ADR-PML-047: Documented Lean theorems missing in the `sigma` subsystem (1 gaps)
...
### Implementation reality (lean/)
  - `JensenShannonMetric` not found among 8285 lean declarations
