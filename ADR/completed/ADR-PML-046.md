# ADR-PML-046: Documented Lean theorems missing in the `zmos` subsystem (1 gaps)
...
### Stated intent (documents)
  - docs/adr/accepted/ADR-061-ZMOS-Production-Implementation.md:99 — asserts `ZmosSupersedes` exists / is verified

### Implementation reality (lean/)
  - `ZmosSupersedes` not found among 8285 lean declarations
