...
\begin{titlepage}
  ...
  \Huge\textbf{DRMM $\times$ CSC} \\
\vspace*{1em}
  \LARGE{Certified Spectral Control of Prime-Scripted Operators (Finite-$P$)}
    \vspace{1.5cm} \\
     \Large{Dr. Ryan Van Gelder, Luis Morató de Dalmases, \\ Tyler Van Osdol\par}
   \vspace{1.5cm}
