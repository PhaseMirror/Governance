...
\begin{enumerate}
\item Shor, P. W. (1997). Polynomial-time algorithms for prime factorization and discrete logarithms on a quantum computer. \textit{SIAM Review}, 41(2), 303-332.

\item Grover, L. K. (1996). A fast quantum mechanical algorithm for database search. \textit{Proceedings of ACM STOC}, 212-219.

\item Gilyén, A., Su, Y., Low, G. H., \& Wiebe, N. (2019). Quantum singular value transformation and beyond. \textit{Proceedings of ACM STOC}, 193-204.

\item Agarwal, A., et al. (2020). The Prime state and its quantum relatives. \textit{Quantum}, 4, 371.

\item IBM Quantum. (2026). Eagle processor specifications. Retrieved from \url{https://quantum.ibm.com}.

\item Qiskit Development Team. (2026). Qiskit: Open-source quantum computing framework. \url{https://qiskit.org}.

\item Multiplicity Theory Foundations. (2026). Prime-indexed recursive stability framework. Internal research documentation.
\end{enumerate}
